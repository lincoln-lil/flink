...
public class RetryableAsyncWaitOperatorFactory<IN, OUT> extends AbstractStreamOperatorFactory<OUT>
    ...
    public RetryableAsyncWaitOperatorFactory(
    ...
    public <T extends StreamOperator<OUT>> T createStreamOperator(
        ...
        if (asyncFunction instanceof RetryableAsyncFunction) {
            RetryableAsyncWaitOperator asyncWaitOperator =
                    new RetryableAsyncWaitOperator(
                            (RetryableAsyncFunction) asyncFunction,
                            timeout,
                            asyncBufferCapacity,
    ...
    public Class<? extends StreamOperator> getStreamOperatorClass(ClassLoader classLoader) {
        if (asyncFunction instanceof RetryableAsyncFunction) {
            return RetryableAsyncWaitOperator.class;
        }
