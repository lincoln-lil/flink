...
/**
 * A retryable async function extends {@AsyncFunction}, defines a doRetry() method for user-function
...
public interface RetryableAsyncFunction<IN, OUT> extends AsyncFunction<IN, OUT> {
    ...
    /**
     * This method is called before the operator finishes, left some preparing work done before
     * function closed.
     */
    void prepareFinish() throws Exception;
