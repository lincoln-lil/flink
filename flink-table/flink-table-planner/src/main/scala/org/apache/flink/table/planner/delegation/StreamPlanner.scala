...
import org.apache.flink.table.planner.plan.validate.StreamPhysicalPlanChecker
...
class StreamPlanner(
  ...
  override protected def validatePhysicalPlan(
    ...
    StreamPhysicalPlanChecker.validatePhysicalPlan(physicalRelNodes, tableConfig)
  }
