...
public class LookupJoinHintOptions {
    ...
    private static Set<ConfigOption> REQUIRED_KEYS = new HashSet<>();
    private static Set<ConfigOption> SUPPORTED_KEYS = new HashSet<>();

    static {
        REQUIRED_KEYS.add(LOOKUP_TABLE);

        SUPPORTED_KEYS.add(LOOKUP_TABLE);
        SUPPORTED_KEYS.add(ASYNC_LOOKUP);
        SUPPORTED_KEYS.add(ASYNC_CAPACITY);
        SUPPORTED_KEYS.add(ASYNC_TIMEOUT);
        SUPPORTED_KEYS.add(ASYNC_OUTPUT_MODE);
        SUPPORTED_KEYS.add(RETRY_PREDICATE);
        SUPPORTED_KEYS.add(RETRY_STRATEGY);
        SUPPORTED_KEYS.add(FIXED_DELAY);
        SUPPORTED_KEYS.add(MAX_ATTEMPTS);
    }
