...
import org.apache.flink.table.plan.nodes.datastream.{DataStreamConvention, DataStreamJoin, StreamTableJoinHTable, StreamTableSourceScan}
...
class StreamTableJoinHTableRule extends ConverterRule(
  ...
  override def matches(call: RelOptRuleCall): Boolean = {
    ...
    !joinInfo.pairs().isEmpty && join.getRight.isInstanceOf[StreamTableSourceScan] &&
      join.getRight.asInstanceOf[StreamTableSourceScan].tableSource.isInstanceOf[HBaseTableSource]
  }
