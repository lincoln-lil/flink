...
/** Utility class to create concrete retry Predicate. */
public class RetryPredicates {
    ...
    private static final class EmptyResultPredicate<T> implements Predicate<Collection<T>> {
    ...
    private static final class HasExceptionPredicate implements Predicate<Throwable> {
    ...
    private static final class ExceptionTypePredicate implements Predicate<Throwable> {
